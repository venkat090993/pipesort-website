...
<div class="lg:w-20 lg:h-20 lg:-mt-10 lg:logo md:w-20 md:h-20  md:mt-20  md:logo sm: w-24 sm: h-24 sm: logo sm: mt-16"><img src="703logo.svg" class=" w-full h-full"  alt="logo" /></div>
